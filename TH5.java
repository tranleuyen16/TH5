...
class ThiNghiem extends PhongHoc {
	...
	public void setSucChua(int sucChua) throws Exception {
		if(sucChua > 50)
			...
			throw new Exception("Suc chua be hon 50!");
	}
...
class DanhSachPhongHoc {
	...
	public boolean themPhongHoc(PhongHoc ph) throws Exception
	{
		if(listPH.contains(ph))
			throw new Exception("Trung ma phong hoc!");
		else
			listPH.add(ph);
		return true;
	}
...
class TH5 {
	...
	public static void main(String[] args) throws Exception {
		...
		do
		{
			...
			case 9:
				...
				break;
			case 10:
				System.out.println("Tong so phong hoc ly thuyet hien co la : "+listPH.tongPhongHocMT());
				break;
			case 11:
	...
	public static int menu()
	{
		...
		System.out.println("##                                             ##");
		System.out.println("#################################################");
		System.out.println("Chon cac chuc nang bang so :");
	...
	{
		inGachNgang1();
		System.out.printf("|%-15s|%-10s|%-15s|%-15s|%-15s|%-15s|\n", "Ma phong hoc", "Day nha", "Dien tich", "So bong den", "May chieu", "Danh gia");
		inGachNgang1();
	}
	...
	{
		inGachNgang1();
		System.out.printf("|%-15s|%-10s|%-15s|%-15s|%-15s|%-15s|\n", "Ma phong hoc", "Day nha", "Dien tich", "So bong den", "So may tinh", "Danh gia");
		inGachNgang1();
	}
	...
	{
		inGachNgang2();
		System.out.printf("|%-15s|%-10s|%-15s|%-15s|%-15s|%-15s|%-15s|\n", "Ma phong hoc", "Day nha", "Dien tich", "So bong den", "Suc chua", "Bon rua", "Danh gia");
		inGachNgang2();
	}
